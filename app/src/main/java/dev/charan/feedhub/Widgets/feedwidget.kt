package dev.charan.feedhub.Widgets
...
object FeedWidget:GlanceAppWidget(){
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        provideContent {
                ...
                openfeedhub.`package`="dev.charan.feedhub"
                openfeedhub.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                val openapp : Intent? = context.packageManager.getLaunchIntentForPackage("dev.charan.feedhub")
