...
fun signin(navHostController: NavHostController) {
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            TextButton(onClick = { showdiologbox = true;navHostController.navigate(dev.charan.feedhub.Navigation.Destinations.password_recover.route) }) {
            ...
            Row(modifier= Modifier
                ...
                Text(text = "Sign Up",modifier=Modifier.clickable { navHostController.navigate(dev.charan.feedhub.Navigation.Destinations.signup.route) }, color = Color(0xff7bc3fe))
